          ...
          <div className="px-[30px] py-[60px] flex justify-center">
            <div className="w-[800px] p-[30px] md:p-[60px] rounded-xl shadow-sm" style={{boxShadow: "0 0 2px 0 rgba(0,0,0,0.75)"}}>
              <div className="flex flex-col gap-2 mb-10">
                ...
                <input className="h-[50px] text-[20px] px-5 py-5 text-gray-500 font-mono border hover:border-green-500 focus:outline-8 focus:outline-green-500 bg-transparent rounded-md transition-all duration-300" type="text" name="name" id="inputname" placeholder="Jovan*" />
              </div>
              <div className="flex flex-col gap-2 mb-10">
