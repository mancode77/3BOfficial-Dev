        ...
        <section>
          <div className="w-full h-fit flex flex-col md:flex-row px-[30px] py-10 gap-3 items-center justify-center">
            <div className="w-full flex justify-center items-center">
              <img className="w-[430px] rounded-md" src="https://ardata.co.id/wp-content/uploads/2021/01/foto-ardata-bareng-press.jpg" alt="" />
            </div>
            <div className="w-full pr-5">
              <h4 className="text-[25px] text-green-600 font-mono font-bold mb-5">Overview</h4>
              <p className="text-[18px] font-mono text-gray-600 mb-5">Ardata Media merupakan anak perusahaan PT Ardata Digital Asia yang fokus bergerak di bidang IT dengan produknya berupa Jasa dan Produk Digital.</p>
              <p className="text-[18px] font-mono text-gray-600 mb-5">Berdiri pada tahun 2015 di Semarang, kini Ardata Indonesia memiliki 5 layanan utama, yaitu Jasa pembuatan Web, Jasa Pembuatan Aplikasi & Software, Jasa Digital Marketing, dan IT Training.</p>
              <p className="text-[18px] font-mono text-gray-600">Tim kami selalu bekerja dengan menerapkan standar & aturan perusahaan secara benar. Untuk memberikan hasil maksimal dan memastikan kepuasan pada client</p>
            </div>
          </div>
        </section>
        <section>
          <div className="w-full h-fit flex flex-col md:flex-row px-[30px] py-[60px] gap-5 bg-[#f9fafb]">
            <div className="w-full px-3 flex flex-col justify-center">
              ...
              <p className="text-[18px] font-mono text-gray-500">Dalam menjalankan usahanya, Ardata Media menerapkan standar etika yang didasarkan pada nilai-nilai perusahaan</p>
            </div>
