      ...
      <main>
          ...
          <div className="h-fit bg-[#E0ECF0] py-10 md:pb-0 pt-[74px]">
            <div className="h-full w-full flex items-center px-[30px]">
              <div className="w-full h-full flex flex-col justify-center">
                <h2 className="text-[30px] text-gray-800 font-semibold font-mono">Partner Digital Untuk Bisnis dan Instansi</h2>
                <p className="text-[24px] my-[24px] text-gray-800 font-mono">Bergabung dengan +570 Client kami dan rasakan manfaat positif dari layanan digital Ardata</p>
              ...
              <div className="w-full h-full hidden md:block">
                <div className="w-full h-full flex justify-center items-end">
                  <img src="https://ardata.co.id/wp-content/uploads/2021/04/7-removebg-preview-1-e1619504562952.png" alt="" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section>
          <div className="w-full flex items-center justify-center py-[40px]">
            <h1 className="text-[25px] md:text-[30px] text-center text-gray-800 font-semibold font-mono">Layanana Terbaik Ardata</h1>
          </div>
          <div className="grid grid-flow-row md:grid-cols-3 gap-5 px-[30px] pb-[60px] ">
            <div className="rounded-md p-10" style={{boxShadow: "0 0 2px 0 rgba(0,0,0,0.75)"}}>
              ...
              <div>
                ...
                <p className="text-[18px] text-gray-500 font-mono">Tingkatkan closing penjualan anda dengan landing page profesional dan terhubung oleh FB / Google Ads</p>
              </div>
            </div>
            <div className="rounded-md p-10" style={{boxShadow: "0 0 2px 0 rgba(0,0,0,0.75)"}}>
              <div className="w-full mb-5">
        ...
        <section>
          <div className="w-full h-fit px-[30px] flex flex-col md:flex-row">
            <div className="w-full px-5 flex items-center">
              <img className="rounded-xl" src="https://ardata.co.id/wp-content/uploads/2021/01/foto-ardata-bareng-scaled.jpg" alt="" />
            </div>
            <div className="w-full flex flex-col justify-center gap-2 p-[30px]">
              <h1 className="text-[30px] text-gray-800 font-mono font-semibold mb-3">Bekerja dengan pengalaman!</h1>
              <p className="text-[18px] text-gray-500 font-mono mb-3">Lebih dari 5 Tahun Ardata Media berdiri dan telah menangani berbagai perusahaan dan instansi. Pada dasarnya tiap individu tim kami adalah praktisi yang sudah memiliki pengalaman di bidangnya masing-masing, kami selalu memberikan layanan dari apa yang telah kami alami dan lakukan.</p>
              <h1 className="py-[17px] px-[40px] bg-[#f9fafb] w-fit rounded-full text-[14px] md:text-[18px] font-mono cursor-default text-gray-800"><FontAwesomeIcon className="text-green-500" icon={faCircleCheck} /> Berpenglaman Lebih Dari 5 tahun</h1>
