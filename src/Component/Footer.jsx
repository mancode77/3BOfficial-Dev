    ...
    <footer>
      <div className="w-full grid md:grid-cols-3 grid-flow-row py-[60px] px-[30px] gap-5 bg-[#E0ECF0]">
        <div className="p-5">
          ...
          <p className="text-[18px] font-mono text-gray-500">Ardata Media merupakan sebuah perusahaan yang bergerak di bidang IT dengan produknya berupa Jasa dan Produk Digital.</p>
        </div>
        <div className="p-5">
          <h1 className="text-[18px] font-semibold mb-5">Navigasi</h1>
          <div className="flex w-full">
            <div className="w-full">
              <p className="text-[18px] text-gray-800 hover:text-green-600 cursor-pointer duration-300 font-semibold mb-5">Layanan Ardata</p>
              <p className="text-[18px] text-gray-800 hover:text-green-600 cursor-pointer duration-300 font-semibold mb-5">Mengenal Ardata</p>
              <p className="text-[18px] text-gray-800 hover:text-green-600 cursor-pointer duration-300 font-semibold">Blog</p>
            </div>
            <div className="w-full">
              <p className="text-[18px] text-gray-500 hover:text-green-600 cursor-pointer duration-300 mb-5">Karir</p>
              <p className="text-[18px] text-gray-500 hover:text-green-600 cursor-pointer duration-300">Magang</p>
            </div>
          </div>
        </div>
        <div className="p-5">
          <div>
            ...
            <p className="text-[18px] text-gray-500">Gedung Business Center UNNES Lantai 3, Semarang, Indonesia</p>
            <div className="flex flex-col gap-2 mt-5">
              ...
              <a href="/" className="w-full text-[18px] px-[40px] py-[15px] bg-white rounded-full text-center font-semibold font-mono text-gray-800 hover:bg-green-400 hover:text-white">info@3bdev.co.id</a>
            </div>
          </div>
        </div>
      </div>
      <div className="grid grid-flow-row md:grid-cols-2 gap-5 md:gap-0 w-full px-[30px] pb-[60px] bg-[#E0ECF0]">
        <div className="flex justify-center md:justify-start">
          <p className="text-gray-500 text-[14px] md:text-[16px]">© 2023 Ardata Media, part of PT Ardata Digital Asia</p>
        </div>
